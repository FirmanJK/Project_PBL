        ...
        <div style="display: flex; flex-wrap: wrap; gap: 20px; margin-bottom: 20px;">
          ...
          <div style="text-align: center;">
            <a href="edit-profile.php"
              style="display: inline-block; text-align: center; padding: 10px 20px; font-size: 14px; background-color: #007bff; color: white; border-radius: 5px; text-decoration: none; transition: background-color 0.3s ease;">Simpan</a>
          </div>
          </div>
