                                    ...
                                    <table class="table text-nowrap mb-0 align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($jurusan as $jrsn): ?>
                                                ...
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= htmlspecialchars($jrsn['first_name'] . ' ' . $jrsn['last_name']); ?>
                                                    </td>
                                                    <td><?= htmlspecialchars($jrsn['email']); ?></td>
                                                    <td><?= htmlspecialchars($jrsn['phone_number']); ?></td>
                                                    <td>
                                                        <a href="edit.php?jurusan_id=<?= htmlspecialchars($jrsn['jurusan_id']); ?>"
                                                            class="btn btn-primary btn-sm">Edit</a>
                                                        <a href="form_handler.php?jurusan_id=<?= htmlspecialchars($jrsn['jurusan_id']); ?>"
