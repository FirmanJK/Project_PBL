                    ...
                    <div class="col d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body p-4">
                                <div class="row mb-4">
                                    <div class="col-10">
                                        <h5 class="fw-semibold">Mahasiswa</h5>
                                    </div>
                                    <div class="col-sm">
                                        <a href="create.php" class="btn btn-primary rounded-8 fw-semibold">Tambah</a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table text-nowrap mb-0 align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($mahasiswa as $mhs): ?>
                                                ...
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= htmlspecialchars($mhs['first_name'] . ' ' . $mhs['last_name']); ?>
                                                    </td>
