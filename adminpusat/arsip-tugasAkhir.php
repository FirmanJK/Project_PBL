    ...
    <div class="col-12">
      ...
      <div class="d-flex flex-column align-items-center mb-4">
        ...
        <div class="input-group mt-2" style="max-width: 500px;">
          <input type="text" class="form-control" id="searchInput" placeholder="Cari Nama Penyusun" aria-label="Cari Nama Penyusun" />
      ...
      <div class="table-responsive" style="max-width: 900px; margin: 0 auto;">
        <table class="table table-striped" style="width:100%;" id="archiveTable">
      ...
      <!-- Footer -->
        <div class="py-6 px-6 text-center">
          ...
          <p class="mb-0 fs-4" style="text-align: bottom;">
            ...
            <span style="color: black;">| Design and Developed by
