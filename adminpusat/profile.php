    ...
    <div class="body-wrapper min-vh-100 d-flex flex-column justify-content-between">
      ...
      <div
        ...
        <div style="text-align: center;">
          <img src="../../../assets/images/profile/Firman.jpg " alt="" width="100" height="100"
        ...
        <form>
          <div class="row mb-1">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" id="first-name" class="form-control" value="Mochammad Firmandika">
              </div>
              <div class="mb-3">
                <label for="nip" class="form-label">NIP</label>
                <input type="text" id="nip" class="form-control" value="1987656789" disabled>
              </div>
              <div class="mb-3">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" id="last-name" class="form-control" value="Jati Kusuma">
              </div>
              <div class="mb-3">
          ...
          <div class="text-center">
            <a href="./editProfile.php" class="btn btn-primary">Edit Profil</a>
          </div>
        </form>
