                    ...
                    <div class="col d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body p-4">
                                <h4 class="fw-semibold card-title">Unggah Dokumen Pusat</h4>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <form>
                                        <div class="mb-3">
                                            <label for="fileSKLA" class="form-label">Surat Keterangan Lunas Administrasi
                                                (SKLA)</label> <br>
                                            <label for="fileSKLA" class="form-sub-label"
                                                style="margin-bottom: 2%;">Surat bukti bahwa telah
                                                membayar biaya administrasi secara lunas <br>(format .pdf, maksimal
                                                2MB)</label>
                                            <input type="file" class="form-control" id="fileSKLA">
                                        </div>
                                        <div class="mb-3">
                                            <label for="fileBebasPustaka" class="form-label">Surat Keterangan Bebas
                                                Pustaka dari Perpustakaan
                                                Pusat</label><br>
                                            <label for="fileSKLA" class="form-sub-label"
                                                style="margin-bottom: 2%;">Surat bukti bahwa tidak
                                                memiliki tanggungandari Perpustakaan Pusat Polinema<br>(format .pdf,
                                                maksimal 2MB)</label>
                                            <input type="file" class="form-control" id="fileBebasPustaka">
                                        </div>
                                        <div class="mb-3">
                                            <label for="fileSimfoni" class="form-label">Bukti Mengisi Data Alumni
                                                (SIMFONI POLINEMA)</label><br>
                                            <label for="fileSKLA" class="form-sub-label"
                                                style="margin-bottom: 2%;">(format .png/.jpg/.jpeg,
                                                maksimal 2MB)</label>
                                        ...
                                        <div class="mb-3 form-check">
                                            ...
                                            <label class="form-check-label" for="cekUlang">* Cek kembali file sebelum
                                                menekan tombol
                                                simpan</label>
                                        </div>
                                        <div class="mb-3 form-check">
                                            <input type="checkbox" class="form-check-input" id="fileTidakBisaDirubah">
                                            <label class="form-check-label" for="fileTidakBisaDirubah">** File yang
                                                telah disimpan tidak bisa
                                                dirubah</label>
                                        </div>
