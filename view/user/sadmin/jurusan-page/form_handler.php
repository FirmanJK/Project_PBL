...
function saveUserData($data, $file) {
    ...
    try {
        ...
        $query = "INSERT INTO Jurusan (first_name, last_name, email, password, phone_number, image, address) 
                  VALUES (:first_name, :last_name, :email, :password, :phone_number, :image, :address)";
