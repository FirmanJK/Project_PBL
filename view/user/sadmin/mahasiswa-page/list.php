                                    ...
                                    <table class="table text-nowrap mb-0 align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                                echo "<tr>";
                                                echo "<td class='border-bottom-0'><h6 class='fw-semibold mb-1'>" . $row["mahasiswa_id"] . "</h6></td>";
                                                echo "<td class='border-bottom-0'>
                                                        <img src='../../../../assets/images/profile/user-1.jpg' width='35' height='35' class='rounded-circle'>
                                                        </td>";
                                                echo "<td class='border-bottom-0'>
                                                        <h6 class='fw-semibold mb-0'>" . $row["first_name"] . "</h6>
                                                        <span class='fw-normal'> Nim (" . $row["nim"] . ")</span>
                                                        </td>";
                                                echo "<td class='border-bottom-0'><p class='mb-0 fw-normal'>" . $row["email"] . "</p></td>";
                                                echo "<td class='border-bottom-0'><div class='d-flex align-items-center gap-2'><span class='badge bg-primary rounded-3 fw-semibold'>" . $row["phone_number"] . "</span></div></td>";
                                                echo "<td class='border-bottom-0'><h6 class='fw-semibold mb-0 fs-4'><a href='edit.php?id=" . $row["mahasiswa_id"] . "'>Edit</a> | <a href='delete.php?id=" . $row["mahasiswa_id"] . "'>Delete</a></h6></td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                        </tbody>
